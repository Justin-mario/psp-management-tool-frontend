  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-semibold mb-4">Introduction to the System</h2>
          <p className="mb-4 text-lg">
            Welcome to the PSP Management Tool, designed to help you implement the Personal Software Process (PSP) in your
            software development work. This tool focuses on PSP0 and PSP0.1, providing a foundation for disciplined software
        ...
        <section>
          ...
          <p className="mb-4 text-lg">Our PSP Management Tool offers the following key functionalities:</p>
          <ol className="list-decimal list-inside mb-4 text-lg space-y-2 pl-4">
